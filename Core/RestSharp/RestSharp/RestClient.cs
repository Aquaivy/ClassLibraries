...
namespace RestSharp
{
    ...
    public partial class RestClient : IRestClient
    {
        ...
        {
            IEnumerable<string> encodedParamters = parameters.Select((Func<Parameter, string>)EncodeParameter);
            string[] encodedParamtersArray = encodedParamters.ToArray();
            return string.Join("&", encodedParamtersArray);
        }
