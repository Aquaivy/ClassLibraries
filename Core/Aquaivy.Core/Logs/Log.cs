...
namespace Aquaivy.Core.Logs
{
    ...
    public static class Log
    {
        ...
        {
            WriteLine(LogMessageType.MSG_NOTICE, message);
        }
        ...
        /// <param name="format"></param>
        /// <param name="param"></param>
        public static void Notice(string format, params object[] param)
        {
            WriteLine(LogMessageType.MSG_NOTICE, format, param);
        }
